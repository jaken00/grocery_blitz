import os
import requests
from models.models import RecipeDetails, Ingredient  # ✅ Import models properly
...
class RecipeCall:   
    ...
    def get_recipe_by_id(self, id):
        recipe_information_url = f'https://api.spoonacular.com/recipes/{id}/information?includeNutrition=false&apiKey={self.key}'
